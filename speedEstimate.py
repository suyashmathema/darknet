...
def estimateSpeed(track_bbs_ids, frame_no):
    print('Tracking bbs id', track_bbs_ids)
    ...
    np.append(score, new_score)
    np.append(track_ids, new_track_ids)
    np.append(frame, new_frame)
    np.append(avg_velocities, estimated_vels)
